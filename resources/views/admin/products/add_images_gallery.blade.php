                ...
                <div class="widget-box">
                    ...
                    <div class="widget-content nopadding">
                        <ul class="recent-posts">
                            ...
                            <li>
                                <form action="{{route('admin.image-gallery.store')}}" method="post" role="form" enctype="multipart/form-data">
                        ...
                        <table class="table table-striped table-bordered">
                            ...
                            <tbody>
                                @foreach($imageGalleries as $imageGallery)
                                    <tr>
                                        <td class="taskDesc" style="text-align: center;vertical-align: middle;">{{$imageGallery->id}}</td>
                                        ...
                                        <a href="{{route('admin.delete-image',$imageGallery->id)}}"  onclick="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
                                      Delete
                                    </a>
